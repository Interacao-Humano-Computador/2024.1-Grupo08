...
<font size="2"><p style="text-align: center"> Figura 12 - Meios de Transporte </p></font>

<center>![alt text](image.png)</center>

<font size="2"><p style="text-align: center"> Fonte: SILVA, Felipe Cláudio Ribeiro da. Luziânia, Plano Diretor e inserção metropolitana. 2019. Dissertação (Mestrado em Arquitetura e Urbanismo) - Faculdade de Arquitetura e Urbanismo, Programa de Pós-Graduação, Universidade de Brasília (UnB), Brasília, DF</p></font>
...
<font size="2"><p style="text-align: center"> Figura 13 - Número de pessoas que moram em Luziânia e trabalham ou estudam no DF </p></font>

<center>![estudam ou trabalham](image-1.png)</center>

<font size="2"><p style="text-align: center"> Fonte: CAMPOS, Neio Lucio de Oliveira (Coord.). Relatório Estadual "Distrito Federal + RIDE". Brasília, DF: Universidade de Brasília, 2010.</p></font>
...
### Qual sua idade?
Majoritariamente, de acordo com a Figura 14, a idade está entre 14 e 24 anos.
<font size="2"><p style="text-align: center"> Figura 14 - Idade </p></font>
![alt text](image-2.png)
<font size="2"><p style="text-align: center"> Fonte:  [Yasmim Rosa](https://github.com/yaskisoba) e [Marco Tulio](https://github.com/MarcoTulioSoares) </p></font>

### Qual seu gênero?
Majoritariamente, de acordo com a Figura 15, o gênero é masculino.

<font size="2"><p style="text-align: center"> Figura 15 - Gênero </p></font>
...
De acordo com a Figura 15, o grau de escolaridade é ensino superior incompleto.

<font size="2"><p style="text-align: center"> Figura 16 - Grau de escolaridade </p></font>
...
Majoritariamente, de acordo com a Figura 17, o nível de conhecimento tecnológico é excelente.
<font size="2"><p style="text-align: center"> Figura 17 - Nível de conhecimento tecnológico </p></font>
...
Todos, de acordo com a Figura 18, tem uma sensibilidade pequena a frustrações decorrente da má usabilidade.

<font size="2"><p style="text-align: center"> Figura 18 - Senbilidade às frustrações </p></font>
...
De acordo com a Figura 19, pelo menos às vezes eles utilizam meios digitais para obter informações de linhas de ônibus, etc.

<font size="2"><p style="text-align: center"> Figura 19 - Frequência de utilização de meios digitais </p></font>
...
De acordo com a Figura 20, os participantes tem uma frequência considerável de compras online.

<font size="2"><p style="text-align: center"> Figura 20 - Frequência de compras online </p></font>
...
Majoritariamente, de acordo com a Figura 21, os participantes utilizam os ônibus da Central Expresso.

<font size="2"><p style="text-align: center"> Figura 21 - Utilização dos ônibus da Central Expresso </p></font>
...
De acordo com a Figura 22, dentre aqueles que utilizam os ônibus da Central Expresso a maioria utiliza frequentemente ou as vezes.

<font size="2"><p style="text-align: center"> Figura 22 - Frequência de utilização dos ônibus da Central Expresso </p></font>
...
De acordo com a Figura 23, dentre aqueles que utilizam os ônibus da Central Expresso, a maioria não tem conhecimento do site da empresa.

<font size="2"><p style="text-align: center"> Figura 23 - Site da Central Expresso </p></font>
...
## Perfil do Usuário
Com base nas informações obtidas podemos então montar o perfil do usuário contido na **Tabela 15**.

<font size="2"><p style="text-align: center"> Tabela 15 - Perfil do Usuário </p></font>
